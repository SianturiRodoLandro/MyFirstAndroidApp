...
public class ListAlkesAdapter extends RecyclerView.Adapter<ListAlkesAdapter.ListViewHolder> {
    private ArrayList<Alkes> listAlkes;

    public ListAlkesAdapter(ArrayList<Alkes> list) {
        this.listAlkes = list;
    }
    ...
    public ListViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_row_alkes, viewGroup, false);
